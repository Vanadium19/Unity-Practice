...
- [Gameplay video](https://example.com)

## Технический стек

- Unity: `2022.3.62f3` (LTS)
- Язык: C#
- Архитектура: модульная, DI + Command
- Сцены:
...
- Перевести ввод на Unity Input System package.
- Добавить сохранение прогресса (монеты/здоровье/позиция).
- Расширить набор команд (магазин, апгрейды, чекпоинты).
- Покрыть доменную логику unit-тестами (кошелёк, здоровье, команды).
